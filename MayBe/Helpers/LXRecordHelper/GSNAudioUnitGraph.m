...
- (void)audioUnitInit
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(cancleNotionce) name:AVAudioSessionInterruptionNotification object:nil];
...
- (void)initFormat {
    ...
    mAudioFormat.mSampleRate         = 16000;//采样率
