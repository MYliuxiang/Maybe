...
class NationalitiesCell: UITableViewCell {
    ...
    var type:CourseWareType?{
        didSet{
            if type == CourseWareType.PinyinEnglish {
                ...
                constraint7.constant = 0
                constraint8.constant = 0
                constraint9.constant = 0
                ...
                constraint7.constant = 18
                constraint8.constant = 18
                constraint9.constant = 18
            }
